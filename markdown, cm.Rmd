...
train.template <- 
  filter(njtransitdf, week %in% c(1: 10))#could filter here for lines
...
#, line) add to the train.panel once add lines to study.panel
...
## get it merge, got set up how it's set up in the book, it should work but investigate
```
